...
function DiseaseSvg(props) {
  return (
    <svg
      aria-hidden="true"
      data-prefix="fas"
      data-icon="disease"
      className="prefix__svg-inline--fa prefix__fa-disease prefix__fa-w-16"
